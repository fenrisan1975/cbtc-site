-- Constance Bay Trading Company — database schema
-- Run this once against your Netlify DB (Postgres/Neon) instance.
-- Netlify DB gives you a connection string in the env var NETLIFY_DATABASE_URL —
-- see SETUP.md for how to run this file against it.
